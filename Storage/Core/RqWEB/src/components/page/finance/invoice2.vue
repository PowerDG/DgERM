...
<template>
  <div class="components-container">
    <div class="editor_left">
      <el-table :data="tablelist" border stripe ref="form" @row-click="opebDetails2">
      ...
      <el-pagination
        ...
        :current-page.sync="paginations2.page_index"
        :page-sizes="paginations2.page_sizes"
        :page-size="paginations2.page_size"
        layout="total, sizes, prev, pager, next, jumper"
        :total="paginations2.total"
          ...
          <!-- <el-form :model="ruleForm" ref="ruleForm" class="demo-ruleForm">
            ...
            >
              ...
              <span slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="hhandleDelete2">确 定</el-button>
              </span>
            </el-dialog>
          </el-form> -->
  ...
  methods: {
    ...
    async getlist2() {
      let res = await reqNewsPagation(
        this.paginations2.page_index,
        this.paginations2.page_size
      );
