...
{ 
    public class TruckInfoService : RQCoreAppServiceBase , ITruckInfoAppService
    {
        ...
        public PagedResultDto<SearchTruckInfoDto> GetPagedTasks(SearchTruckInfoInput input)
        {
            //初步过滤
            ...
            return new PagedResultDto<SearchTruckInfoDto>(tasksCount, taskList.MapTo<List<SearchTruckInfoDto>>());
        }
        ...
        {
            var task = _TruckInfoRepository.FirstOrDefault(t => t.TruckID == taskId);
