...
namespace RQCore.IRQAppService
{
    public interface IBillInfoAppService : IApplicationService
    {
        ...
        string UpdateMission(BillInfoDto input);
        //  string UpdateMission_admin(BillInfoDto input);
        BillInfoDto CheckBillInfo(int BillNo);
        ...
        PagedResultDto<SearchBIllInfoDto> GetPagedBillInfos(SearchBillInfoInput input);
        ...
        IList<SelectDto> GetAllCompanyList();
